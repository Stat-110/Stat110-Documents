...
![Histogram of solar panels on all Weberville buildings](images/lab3_7hist.png)

See histogram below. The highest frequencies are buildings with less than 5 squares. The histogram is slightly skewed right, since only a handful of buildings have more than 15 squares.
